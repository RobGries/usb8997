			...
			IN pmlan_ioctl_req pioctl_req)
{
	...
	if (pioctl_req->action == MLAN_ACT_GET) {
		...
		/* after initialize private structures, 11n and 11ac dev cap params would be reset to 0.
		   and following init_cmd does not call get_hw_spec command for 2nd argu was false.
		   so we should udapte 11n and 11ac dev cap params by hw value */
