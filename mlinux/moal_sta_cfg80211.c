...
woal_cfg80211_suspend(struct wiphy *wiphy, struct cfg80211_wowlan *wow)
{
	...
	for (i = 0; i < wow->n_patterns; i++) {
		...
		if (first_pat)
			...
			mef_entry->rpn[filt_num] = RPN_TYPE_AND;
		...
		if (!ret) {
			...
			passoc_rsp =
                ...
                struct cfg80211_roam_info roam_info = {
                        .channel = NULL,
                        .bssid = priv->cfg_bssid,
                        .req_ie = priv->sme_current.ie,
                        .req_ie_len = priv->sme_current.ie_len,
                        .resp_ie = passoc_rsp->ie_buffer,
                        .resp_ie_len = assoc_rsp.assoc_resp_len - ASSOC_RESP_FIXED_SIZE,
                };
